...
class Authorization_Token
{
    ...
    public function tokenIsExist($headers)
    {
        ...
        return ['status' => FALSE, 'message' => 'Token is not defined.  Pilih Headers, pada key isi dengan Authorization. Kemudian untuk value diisi dengan menggunakan token yang telah disediakan.'];
        // return ['status' => FALSE, 'message' => 'Pilih Headers.'];
        // return ['status' => FALSE, 'message' => 'Pada key isi dengan Authorization'];
        // return ['status' => FALSE, 'message' => 'Kemudian untuk value diisi dengan menggunakan token yang telah disediakan.'];
    }
